...
const MangaCardSkeleton = () => {
    return (
        <div
            className={`relative rounded-lg cursor-pointer w-[120px] h-[170px] xm:w-[160px] xm:h-[200px] md:w-[300px] md:h-[300px] lg:w-[300px] lg:h-[530px] overflow-hidden shadow-lg bg-white transform transition-transform animate-pulse`}
